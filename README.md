...
# NOIR MEN'S CLINIC — Recruitment Site Proposal

**洗練された、男性のための医療体験。**

架空のメンズクリニック「NOIR MEN'S CLINIC」採用サイトの制作企画書。
WordPress テーマでの実装を想定した、ヒアリング想定から技術設計までを一冊にまとめた提案ドキュメントです。

<br />

![NOIR MEN'S CLINIC Preview](./assets/images/preview.png)
...
![Print Ready](https://img.shields.io/badge/Print_to_PDF-A4-d4af37?style=flat-square)
...
> 「医療の信頼感」と「美容の上質さ」を両立させる、**男性のための洗練された採用体験**

メンズ美容クリニックは「医療」と「美容」が交差する領域です。だからこそ採用サイトは、医療機関としての信頼感を担保しつつ、ブランドとしての洗練を伝える必要があります。求職者にとっての「ここで働きたい理由」を、視覚体験として翻訳することを設計の起点としました。
...
### 1. ヒアリング想定の解像度
「ご相談のきっかけ」「現状の採用課題」「競合との差別化軸」など、実案件で確認されそうな項目を網羅的に書き出しました。
...
### 4. ターゲット別の導線設計
看護師・医師・カウンセラーなど職種ごとに異なる「不安」を想定し、職種別の訴求ポイントを企画書で整理しました。
...
├── README.md
├── proposal.pdf               # PDF版企画書(A4 縦・9ページ)
├── css/
│   └── style.css              # デザイントークン + 印刷対応
└── assets/
    └── images/
        ├── preview.png        # 実装サイトのモックアップ(PC + スマホ)
        └── qrcode.jpg         # 実装サイト(Local Live Link)への QR
```
...
<img src="./assets/images/preview.png" alt="NOIR MEN'S CLINIC PC & Mobile Preview" width="100%" />
...
<img src="./assets/images/qrcode.jpg" alt="NOIR MEN'S CLINIC QR Code" width="220" />
